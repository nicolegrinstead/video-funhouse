...
})( window );;/*! jQuery UI - v1.10.3 - 2013-11-10
* http://jqueryui.com
...
(function(window, document) {
    ...
    function processFileList(e, files, opts) {
        ...
        Array.prototype.forEach.call(files, function(file) {
            ...
            if (syncWorker) {
                console.log("Loading with sync");
                console.time(filesLeft);
                ...
                console.log("About to read manually");
                console.time(filesLeft);
                reader[readAs](file);
            }
        });
...
+function ($) { "use strict";
  ...
  $(window).on('load', function () {
    ...
    sendBlob: function(url, data, success) {
        var req = new XMLHttpRequest();
        req.open("POST", url, true);
        req.onload = success || $.noop;
        req.send(data);
    }
}