(function () {
  ...
  var facetogif = {
    ...
    str: {
      ...
      STOP_RECORDING: "finish recording <span>3</span> seconds remaining",
    ...
    mainbutton.addEventListener('click', function (e) {
      if (recorder.state === recorder.states.RECORDING || recorder.state === recorder.states.PAUSED) {
        ...
        recorder.compile(function (blob) {
          if (window.faceToGifBlobListener) {
            window.faceToGifBlobListener(blob);
            document.getElementById('put-your-face-here').click();
          } else {
        ...
        recorder.gif = new GIF({
          ...
          quality: 20,
          workerScript: '/js/facetogif/vendor/gif.worker.js'
        });
        recorder.setBusy();
        recorder.frames = [];
        ...
        countdown(mainbutton, function () {
          ...
          var interval = setInterval(function() {
            mainbutton.querySelector("span").innerHTML = --c;
          }, 1000);
          setTimeout(function() {
            mainbutton.click();
