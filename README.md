...
~~~sh
# getting the code
git clone git@github.com:nko4/devcomo.git && cd ./devcomo/
...
# deploying (to http://devcomo.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@devcomo.2013.nodeknockout.com
ssh root@devcomo.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@devcomo.2013.nodeknockout.com
ssh -i ./id_deploy root@devcomo.2013.nodeknockout.com
~~~
